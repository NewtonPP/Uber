...
const VehiclePanel = ({setisVehiclePanelOpen, setConfirmedRidePanel}) => {
  return (
    <div>
      <h5 
        ...
        <h2 className='text-xl font-semibold py-2'>Choose a vehicle</h2>
          ...
          <div className='flex border-2 hover:border-black rounded-xl items-center justify-between p-5' onClick={()=>setConfirmedRidePanel(true)}>
            ...
            <h2 className='text-xl font-semibold'>$12.88</h2>
          </div>
          ...
          <div className='flex border-2 hover:border-black rounded-xl items-center justify-between p-5'>
            ...
            <h2 className='text-xl font-semibold'>$6.89</h2>
          </div>
    </div>
  )
}
